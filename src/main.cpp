...
float ui_normalWeight = 7.5f;
float ui_positionWeight = 5.2f;
...
void runCuda() {
	...
	if (iteration < ui_iterations) {
		...
		//ADD TIMER STUFF HERE FOR PERF ANALYSIS 
	...
	if (iteration == ui_iterations) {
		...
		if (ui_denoise) 
		{
			denoise(ui_colorWeight, ui_colorWeight, ui_positionWeight, ui_filterSize);
